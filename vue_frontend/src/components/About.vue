  ...
  <transition appear name="fade">
    <div class="about">
        ...
        <b-row>
          ...
          <b-col lg=6 xl=4 class="pb-3">
            <b-card style="height: 100%">
              ...
              <b-card-text>
                <small>ADAPT leverages predictive models of detection activity. It includes a pre-trained machine learning model of <i>Lwa</i>Cas13a CRISPR guide RNA activity, trained from ~19,000 guide-target pairs, and uses a heuristic model for RPA primers.</small>
              </b-card-text>
            </b-card>
          </b-col>
          <b-col lg=6 xl=4 class="pb-3 mx-md-auto">
            <b-card style="height: 100%">
              ...
              <b-card-text>
                <small>crRNAs are designed to distinguish closely-related species or subspecies, allowing them to be grouped into panels that are accurate in identifying taxa.</small>
              </b-card-text>
            </b-card>
          </b-col>
        </b-row>
      ...
      <b-row class="pt-5 pb-4">
        ...
        <b-col>
          <p class="f-4">We pre-designed assays against >1,500 known vertebrate-infecting viruses, ready for experimental validation, by harnessing all the genomes for each virus in NCBI’s databases. ADAPT’s output includes a visualized list of assay options ranked by predicted performance.</p>
        </b-col>
      </b-row>
      <b-row class="pt-4 pb-5">
        ...
        <b-col lg=4 class="h3 text-center my-auto pb-3">
          <a href="/" style="letter-spacing: inherit;">Run ADAPT</a>
        </b-col>
        <b-col class="d-lg-none">
          <p class="f-4">If there is a virus we have not designed for, you have custom sequences, or you require control over design parameters, you can run ADAPT easily through our web interface.</p>
        </b-col>
      </b-row>
      <p class="pt-5">Currently, ADAPT is directly suited to Cas13a-based diagnostics, e.g., with the SHERLOCK, SHINE, or CARMEN platforms. Future versions will extend ADAPT's predictive models to work with other nucleic acid detection technologies.</p>
